      ...
      <div className={styles.a4Paper} translate="no">
        ...
        <table className={styles.printMarginTable}>
          ...
          <div className={styles.metaItem}>
            ...
            <span className={styles.metaValue}>{new Date(auditData.date).toLocaleDateString('pt-BR', { timeZone: 'UTC' })} - {auditData.endTime ? `${auditData.startTime} às ${auditData.endTime}` : auditData.startTime}</span>
          </div>
          <div className={styles.metaItem}>
